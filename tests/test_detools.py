...
class DetoolsTest(unittest.TestCase):
    ...
    def test_command_line_patch_info_foo(self):
        ...
        self.assertEqual(stdout.getvalue(),
                         'Type:               normal\n'
                         'Patch size:         171 bytes\n'
                         'To size:            2.71 KiB\n'
                         'Patch/to ratio:     6.2 % (lower is better)\n'
    ...
    def test_command_line_patch_info_foo_no_delta(self):
        ...
        self.assertEqual(stdout.getvalue(),
                         ...
                         'Patch size:         95 bytes\n'
                         'To size:            2.71 KiB\n'
                         'Patch/to ratio:     3.4 % (lower is better)\n'
    ...
    def test_command_line_patch_info_foo_in_place(self):
        ...
        self.assertEqual(
            ...
            'From offset:        0 bytes\n'
            'Type:               normal\n'
            'Patch size:         999 bytes\n'
            'To size:            1.25 KiB\n'
            'Patch/to ratio:     78.0 % (lower is better)\n'
            'Diff/extra ratio:   0.0 % (higher is better)\n'
            'Size/data ratio:    0.3 % (lower is better)\n'
            'Compression:        lzma\n'
            '\n'
    ...
    def test_command_line_patch_info_foo_in_place_size_units(self):
        ...
        self.assertEqual(
            ...
            'From offset:        0 bytes\n'
            'Type:               normal\n'
            'Patch size:         955 bytes\n'
            'To size:            1.21 KiB\n'
            'Patch/to ratio:     76.8 % (lower is better)\n'
            'Diff/extra ratio:   0.0 % (higher is better)\n'
            'Size/data ratio:    0.3 % (lower is better)\n'
            'Compression:        lzma\n'
            '\n'
